...
const fallbackStatusLabel = { text: '未知状态', color: 'bg-zinc-100 text-zinc-500' }
    ...
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      <div className="space-y-2">
        {analyses.map(analysis => {
          const statusLabel = statusLabels[analysis.status] || fallbackStatusLabel
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded ${statusLabel.color}`}>
                    {statusLabel.text}
                  </span>
